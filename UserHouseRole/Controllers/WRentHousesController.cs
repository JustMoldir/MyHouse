...
{
    public class WRentHousesController : Controller
    {
        private readonly ApplicationDbContext _context;
        private readonly IWebHostEnvironment _hostEnvironment;

        public WRentHousesController(ApplicationDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        public IActionResult kot1()
        {

            return View();
        }
        public IActionResult kot2()
        {

            return View();
        }
        public IActionResult kot3()
        {

            return View();
        }

        public IActionResult Loan_single()
        {
        ...
        // GET: RentHouses
        public async Task<IActionResult> Buy_single()
        {
            return View(await _context.RentHouse.ToListAsync());
        }

        public async Task<IActionResult> Single1(int? id)
        {
            if (id == null)
            {
                return NotFound();
